...
UCLASS(config=Game)
class Atry1Pawn : public AWheeledVehicle
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(Category = Control, VisibleDefaultsOnly, BlueprintReadOnly)
	...
	/** The current Throttle Scale as a string  */
	UPROPERTY(Category = Control, EditAnyWhere, BlueprintReadOnly)
	float ThrottleScale;

	/** The current Throttle Force as a string  */
	UPROPERTY(Category = Control, EditAnyWhere, BlueprintReadOnly)
	float ThrottleForce;
...
public:
	...
	// IncreaseThScale
	void IncreaseThScale();

	void DecreaseThScale();
